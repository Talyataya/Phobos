...
class CfgVehicles
{
	...
	class Phobos_AIStance_Module_Base : Phobos_Module_Base
	{
		subCategory = "Set AI Stance";
	};
	...
	class Phobos_Cutscene_Module_Base : Phobos_Module_Base
	{
	...
	#include "cfgVehiclesAIStance.hpp"
	#include "cfgVehiclesCombatAnimations.hpp"
	#include "cfgVehiclesCutscene.hpp"
