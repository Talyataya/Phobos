...
// Author: Talya
// Version: 1.0
// Description: Assigns name on placed object: 'object1'. (Useful when not having Developer Console.)
// Changelog: None
//
//////////////////////////////////////////////////////////////
...
{
	object1 = _unitUnderCursor;
	["This object is now named as 'object1'."] call Ares_fnc_ShowZeusMessage;
}
else
{
