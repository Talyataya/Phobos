...
// Author: Talya
// Version: 1.0
// Description: Assigns name on placed object: 'object3'. (Useful when not having Developer Console.)
// Changelog: None
//
//////////////////////////////////////////////////////////////
...
{
	object3 = _unitUnderCursor;
	["This object is now named as 'object3'."] call Ares_fnc_ShowZeusMessage;
}
else
{
