...
if (count _cutsceneCams == 0) exitWith {["No camera available to create a cutscene."] call Phobos_fnc_logMessage};

//Delete if any cutscene exists.
_output pushback format ["_cutsceneName = %2;%1%1[_cutsceneName] call Phobos_fnc_cutsceneDelete;%1", endl, _cutsceneName];
